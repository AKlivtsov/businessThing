...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.m_change = QtWidgets.QMenu(parent=self.menubar)
        self.m_change.setObjectName("m_change")
        ...
        self.menubar.addAction(self.m_change.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.m_change.setTitle(_translate("MainWindow", "сменить таблицу"))
